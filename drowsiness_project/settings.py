...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "fallback-secret-key")  # Use a fallback if missing

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True  # Force DEBUG mode to serve static files
...
ROOT_URLCONF = "drowsiness_project.urls"
